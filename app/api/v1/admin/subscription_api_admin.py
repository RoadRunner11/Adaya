...
@api_v1.route('/connect/subscribe/pagination', methods=['GET'])
#@admin_only
def get_subscription_pages(id=None): # pagination details for all products
    ...
    page_details =  UserSubscription.get_items_pages(id=id, page=page, per_page=per_page, sort_by=sort_by, is_desc=is_desc)
