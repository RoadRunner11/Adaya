...
ALLOW_ORIGIN = ['http://localhost:8010', 'http://localhost:8000', 'https://adaya.netlify.app', 'https://adayahouse.netlify.app' ]#['https://adaya.netlify.app', 'https://adayahouse.netlify.app']
