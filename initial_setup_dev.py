...
if __name__ == "__main__":
	...
	with app.app_context():
		...
		STRIPE_PUBLISHABLE_KEY = ConfigValues('STRIPE_PK', 'pk_test_wfEV385fd15MX1lKUFsPpG1F00EVVb5Dl7')       
		STRIPE_S_KEY = ConfigValues('STRIPE_SK', 'sk_test_Fp5a2iT7YRDCEckASE3ExS5q004e2IXvcs') 
		STRIPE_WEBHOOK_KEY = ConfigValues('STRIPE_WHS', '')
		...
		usersubscription.end_date=datetime.strptime('06-09-2020 05:58:00', '%d-%m-%Y %H:%M:%S')
		...
		for x in range(25):
			...
			order_item.start_date = datetime.strptime('1-7-2020', '%d-%m-%Y')
			order_item.end_date = datetime.strptime('8-7-2020', '%d-%m-%Y')
			order.order_items = []
		...
		db.session.add(STRIPE_WEBHOOK_KEY)
		...
		voucher.redeem_by = datetime.strptime('13-7-2020', '%d-%m-%Y')
		voucher2 = Voucher('LUO20')
		voucher2.discount_fixed_amount = 20
		voucher2.product_id = 2
		voucher2.redeem_by = datetime.strptime('18-7-2020', '%d-%m-%Y')        
